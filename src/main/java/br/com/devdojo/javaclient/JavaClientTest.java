...
public class JavaClientTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            reader = new BufferedReader(new InputStreamReader(connection.getInputStream())); //fazer requisicao e obter resposta
            StringBuilder jsonSB = new StringBuilder(); //armazenar resposta
            String line;
